...
! calculate the factors
  ...
  Factor_Joule_energy_eV  = N_in_macro * delta_x_m * E_z_ext_Vm
...
! rate of change of full energy, kinetic energy, potential energy
  ...
  ELSE
     ...
     Energy_heat_eV         =  Energy_heat_eV + Factor_Joule_energy_eV * Rate_energy_heat       ! new, total energy change due to external electric field
     Rate_energy_heat_eVns1 = (Energy_heat_eV - old_Energy_heat_eV) * Factor_rate_ns1           ! new, rate of change of energy due to external electric field, dimensional
